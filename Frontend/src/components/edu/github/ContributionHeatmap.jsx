  ...
  const fetchHeatmapData = async () => {
    try {
      ...
      const response = await axios.get(
        userId ? `http://localhost:3000/projects/heatmap/${userId}` : 'http://localhost:3000/projects/heatmap',
        {
          headers: {
  ...
  if (loading) {
    return (
      <div className="h-32 bg-gray-50 rounded-lg animate-pulse flex items-center justify-center">
        <div className="text-sm text-gray-400">Loading contribution data...</div>
      </div>
    );
  }
          ...
          <div className="flex justify-end mt-2">
            <div className="flex items-center text-xs text-gray-500">
              ...
              <div className="flex mx-1">
                ...
                <div className="w-3 h-3 bg-green-100 rounded-sm mx-px"></div>
                <div className="w-3 h-3 bg-green-300 rounded-sm mx-px"></div>
                <div className="w-3 h-3 bg-green-500 rounded-sm mx-px"></div>
                <div className="w-3 h-3 bg-green-700 rounded-sm mx-px"></div>
              </div>
              <span>More</span>
            </div>
          </div>
