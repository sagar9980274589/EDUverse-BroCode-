...
const FloatingChatbot = () => {
  ...
  const [messages, setMessages] = useState([
    {
      text: "Hello! I'm EDUverse Assistant. Welcome to EDUverse!<br /><br />" +
            "<strong>About EDUverse:</strong><br />" +
            "This platform was created by team \"BROcode\" of Adichunchanagiri Institute of Technology.<br /><br />" +
        ...
        <div className="absolute bottom-16 left-0 w-80 sm:w-96 h-[500px] bg-white rounded-lg shadow-xl flex flex-col overflow-hidden border border-gray-200">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-3">
            {messages.map((msg, index) => (
              <div key={index} className={`flex w-full ${msg.sender === "bot" ? "justify-start" : "justify-end"}`}>
                <div
          ...
          <div className="p-3 border-t border-gray-200 flex items-center">
            ...
            />
            <button
              className="ml-2 p-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition disabled:opacity-50"
              onClick={sendMessage}
              disabled={loading}
            >
              <Send size={20} />
